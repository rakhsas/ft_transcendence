...
function SidebarComponent(): JSX.Element {
  ...
  return (
    <>
      <div className="Side ml-8 mt-16 w-24 h-3/4 rounded-[25px] border-2 relative">
        <div className="h-full py-5 bg-[#2C2729] rounded-3xl top-0 left-0 right-0 bottom-0 flex flex-wrap justify-center items-center">
          ...
          <div className="w-full space-y-5 h-1/6 flex flex-col justify-center items-center">
